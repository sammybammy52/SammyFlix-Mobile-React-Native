  ...
  return (
    <TouchableOpacity className='flex-row bg-black py-3 gap-4 pl-2' onPress={handlePress}>
      <Image source={{
        ...
        <View className='w-[60%]'>
            <Text className='text-white font-medium text-lg'>{movie.title || movie.name}</Text>
            <Text className='text-gray-400 text-sm'>{movie.release_date || movie.first_air_date}</Text>
